...
LOAD DATA LOCAL INFILE 'C:/Users/user/git/causal-rules/database_generator/organization.csv'
INTO TABLE organization FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
